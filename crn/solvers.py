...
class PGDSolver(ProxSolver):
    ...
    def solve(
        ...
        # Honour the configured step size (as documented) when it is a
        # positive value; a non-positive ``pgd_step_size`` (e.g. 0) opts
        # into automatic, metric-aware step-size selection instead.
        if self.cfg.pgd_step_size > 0:
